...
const PREDICTION_KEY = 'f1-2026';

export default async function F1DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900">F1 Season {SEASON_YEAR} Predictions</h2>
      </div>
